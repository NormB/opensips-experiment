...
// This shim could probably be generated by a procedural macro on
// `reply`.
extern "C" fn reply_shim(
    arg_msg: *mut opensips::sip_msg,
    _ctx: *mut c_void,
    _arg2: *mut c_void,
    _arg3: *mut c_void,
    _arg4: *mut c_void,
...
#[instrument(skip_all)]
extern "C" fn reply(msg: &mut opensips::sip_msg) -> i32 {
    info!("called");
...
unsafe fn param_to_str<'a>(p: *mut c_void) -> &'a str {
...
#[instrument]
fn test_str(s1: &str, s2: &str) -> bool {
    info!("called");
